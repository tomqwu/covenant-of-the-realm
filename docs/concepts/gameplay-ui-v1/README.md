...
照禾人曾在涨水前转移药苗；调查会写入当前 save v13、改变石面余留并隐藏一次性行动，
...
系上纸签。save v11 引入二选一结果，当前 save v13 继续保存，并把它写进札记、章节结算和余波对白，但不发放
资源、战斗加成或隐藏关系数值。
...
回应。逐句中断仍由 save v13 恢复，两个收束选择只留下原创事件回声，不发隐藏奖励。
...
- 捕获脚本只在写图时固定动画帧、反馈相位与转场时点，连续两轮全部 PNG 哈希一致；
