...
- 静态场景为 115 节点、峰值 125，山道态为 121，陶小满巡路态为 123、端点对话态为 125，三种石室仪轨状态均为 116、完成态为 118、标题态为 123、对话叠加札记为 125，场景销毁后零泄漏；
- 六套肖像 v2 在同尺寸总览与真实对话框中保留独立轮廓、神情和随身物件，晨桃色只作低频暖光；
- 捕获脚本只在写图时固定动画帧、反馈相位与转场时点，连续两轮 42 张 PNG 的聚合 SHA-256 均为 `f56422804793b50d4ee20e5b9a733bb7a5d61a4599771648a0a3028f2fb51bb7`；
