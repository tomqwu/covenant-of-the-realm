...
1152×648 实际游戏画面。主角、砚青、梁叔、四类敌人、渡口与山道地表已经接入项目原创、确定性
...
照禾人曾在涨水前转移药苗；调查会写入当前 save v11、改变石面余留并隐藏一次性行动，
...
不跳动。四种头像都是项目代码确定性绘制的明亮纸绘首轮占位，不是从概念图裁切的
...
系上纸签。save v11 保存二选一结果，并把它写进札记、章节结算和余波对白，但不发放
资源、战斗加成或隐藏关系数值。
...
回应。逐句中断仍由 save v11 恢复，两个收束选择只留下原创事件回声，不发隐藏奖励。
