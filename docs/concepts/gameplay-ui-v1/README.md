...
五张战斗参考图现在都在右侧状态栏下方保留固定屏幕空间的“照禾临势签”。暖纸签
...
- 静态场景为 116 节点、峰值 126，山道态为 122，陶小满巡路态为 124、端点对话态为 126，三种石室仪轨状态均为 117、完成态为 119、标题态为 124、对话态为 126，札记与普通敌替换的即时/稳定采样均为 125，场景销毁后零泄漏；
- 六套肖像 v2 在同尺寸总览与真实对话框中保留独立轮廓、神情和随身物件，晨桃色只作低频暖光；
- 捕获脚本只在写图时固定动画帧、反馈相位与转场时点，连续两轮 42 张 PNG 的聚合 SHA-256 均为 `3bb142fb4e31bd4d13c1a5fe96c45183ccf91b5562e168036ff0d69de6054716`；
