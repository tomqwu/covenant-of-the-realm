...
重新遮住。该偏好只保存在独立 settings 文件，save v16 仍只记录结构化对话行号。
...
- 静态场景为 114 节点、峰值 124，巡路态为 122，三种石室仪轨状态均为 115、完成态为 117，场景销毁后零泄漏；
- 六套肖像 v2 在同尺寸总览与真实对话框中保留独立轮廓、神情和随身物件，晨桃色只作低频暖光；
- 捕获脚本只在写图时固定动画帧、反馈相位与转场时点，连续两轮 41 张 PNG 的聚合 SHA-256 均为 `6e1c0f5b3bca174f25726bfec6de61c86bb9962e57641ca29de90717dc68f4b7`；
- 下一步是更密集的 NPC 日程、更长的原创支线内容和进一步人物制作精修。
