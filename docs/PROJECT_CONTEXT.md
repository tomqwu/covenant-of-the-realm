...
7. side-story-, discovery-, harvest-, battle-status-, enemy-, dialogue-, and map-aware save v11, title/continue, safe backup recovery, chapter replay, and an input-safe no-spoiler journey journal (implemented; v1–v10 migrate explicitly);
