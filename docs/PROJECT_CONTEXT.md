...
7. discovery-, harvest-, battle-status-, enemy-, dialogue-, and map-aware save v10, title/continue, safe backup recovery, chapter replay, and an input-safe no-spoiler journey journal (implemented; v1–v9 migrate explicitly);
