...
| Godot RPG rules and scenes | headless GDScript harness | 477 assertions passing, including focus-blocking/reduced-motion transitions, Y-depth occlusion, selectable harvesting, save v9, enemy-atlas selection, presentation independence, shared-resolver boss, dialogue, and exploration contracts |
