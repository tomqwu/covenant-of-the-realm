...
| Godot performance and lifecycle | versioned headless budget | 100,000 collision moves, 50,000 bounded companion-trail updates, and 2,000 complete battle-rule loops each under 2.5 s; 20 scene create/destroy cycles under 5 s; measured title/path/dialogue/battle-immediate/battle-stable/journal peaks are 118/116/120/120/120/120 nodes with zero root-child leaks |
