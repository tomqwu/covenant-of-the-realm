...
| Godot RPG package and reference captures | double export/capture | eight source atlases regenerate twice and match their Git-index blobs byte-for-byte; with pinned Godot 4.7.1, the 697,160-byte PCK is byte-reproducible within each build host, with macOS SHA-256 `2f1c122199227f9c9a02537a4b9311c44f8ed03285c8b87267c995b6e45cf5a5` and Linux CI SHA-256 `1b8a4a14b9e72fb5352711bda70794203627b476221abdc789f31da38c605713`, without a cross-OS byte-identity claim; both gates explicitly probe 22 required runtime resources, including the settings store, main presentation controller, enemy semantic adapter/catalog, and camera policy, while excluding nine `tests/`/`tools/` resources; two consecutive 41-PNG capture runs have identical aggregate SHA-256 `6e1c0f5b3bca174f25726bfec6de61c86bb9962e57641ca29de90717dc68f4b7`, including the 3×2 portrait comparison board, readable standard/instant title-pause controls, expanded ferry/path framing, semantic battle poses, ferry-runner map/choice/worksite states, all three life landmarks, and all three spring ritual states |
