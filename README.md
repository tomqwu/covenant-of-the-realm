...
currently reach 100%. Godot behavior is covered by 686 headless rule/scene assertions plus an
independent 96-check chapter E2E and 38-check physical-input/focus path. The MUD adapter has
