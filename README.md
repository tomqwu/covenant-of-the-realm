...
可恢复分支对话、近距离采集、可撤退回合战斗、同伴援护、版本化存档和首次境界突破；现有多人
...
currently reach 100%. Godot behavior is covered by 301 headless rule/scene assertions plus an
independent 39-check chapter E2E and 20-check physical-input/focus path. The MUD adapter has
