...
currently reach 100%. Godot behavior is covered by 185 headless rule/scene assertions plus an
independent 16-check chapter E2E. The MUD adapter has isolated Evennia tests, and its release path
