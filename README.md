...
currently reach 100%. Godot behavior is covered by 254 headless rule/scene assertions plus an
independent 30-check chapter E2E and 18-check physical-input/focus path. The MUD adapter has
