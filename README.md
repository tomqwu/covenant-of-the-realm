...
currently reach 100%. Godot behavior is covered by 260 headless rule/scene assertions plus an
independent 33-check chapter E2E and 18-check physical-input/focus path. The MUD adapter has
