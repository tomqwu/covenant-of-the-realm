...
可恢复分支对话、脚印式同伴跟随、持久环境见闻、近距离采集、三类可预判敌人、守巢首领、可撤退回合战斗、同伴援护、版本化存档和首次境界突破；现有多人
...
currently reach 100%. Godot behavior is covered by 546 headless rule/scene assertions plus an
independent 65-check chapter E2E and 27-check physical-input/focus path. The MUD adapter has
